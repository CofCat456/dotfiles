...
我使用 `asvetliakov.vscode-neovim` 搭配 [`Innei vscode neovim setting`](https://github.com/Innei/vscode-nvim-config)
...
來源自 [`antfu dotfiles`](https://github.com/antfu/dotfiles)
